...
import org.candlepin.subscriptions.a_ashared.model.OptInType;
import org.candlepin.subscriptions.a_ashared.config.security.WithMockRedHatPrincipal;
import org.candlepin.subscriptions.a_worker.config.ReportingAccountWhitelist;
...
public class OptInResourceTest {
    ...
    @MockBean
    private ReportingAccountWhitelist accountWhitelist;

    @MockBean
    private OptInController controller;

    @Autowired
    private OptInResource resource;
