...
import org.candlepin.subscriptions.a_ashared.config.RhsmSubscriptionsDataSourceConfiguration;
import org.candlepin.subscriptions.a_ashared.config.HttpClientProperties;
import org.candlepin.subscriptions.a_ashared.config.security.rbac.RbacApiFactory;
...
@ComponentScan(basePackages = "org.candlepin.subscriptions.a_ashared.config.security.security")
    ...
    public static class ApiConfiguration extends WebSecurityConfigurerAdapter {
        ...
        protected void configure(HttpSecurity http) throws Exception {
            String apiPath = env.getRequiredProperty(
                "rhsm-subscriptions.package_uri_mappings.org.candlepin.subscriptions.a_shared.resteasy");
            http
