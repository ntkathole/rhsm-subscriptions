 ...
 */
package org.candlepin.subscriptions.a_worker.config;

import org.candlepin.subscriptions.ApplicationProperties;
import org.candlepin.subscriptions.a_ashared.config.JmxBeansConfiguration;
import org.candlepin.subscriptions.a_worker.service.collector.FactNormalizer;
import org.candlepin.subscriptions.a_worker.service.TallyTaskFactory;
import org.candlepin.subscriptions.a_ashared.config.ProductIdMappingConfiguration;
import org.candlepin.subscriptions.a_ashared.config.ProductIdToProductsMapSource;
import org.candlepin.subscriptions.a_ashared.config.HttpClientProperties;
import org.candlepin.subscriptions.a_worker.service.task.TaskQueueProperties;
import org.candlepin.subscriptions.a_worker.service.task.queue.TaskConsumer;
import org.candlepin.subscriptions.a_worker.service.task.queue.TaskConsumerFactory;
...
@Import({ TallyTaskQueueConfiguration.class, TaskConsumerConfiguration.class,
    ProductIdMappingConfiguration.class, InventoryDataSourceConfiguration.class,
    JmxBeansConfiguration.class })
@ComponentScan(basePackages = { "org.candlepin.subscriptions.a_worker" })
public class TallyWorkerConfiguration {
    ...
    public FactNormalizer factNormalizer(ApplicationProperties applicationProperties,
        ...
        RoleToProductsMapSource productToRolesMapSource, ApplicationClock clock) throws IOException {
