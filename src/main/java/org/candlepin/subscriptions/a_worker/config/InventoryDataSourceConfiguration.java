...
import org.candlepin.subscriptions.a_ashared.config.PostgresTlsDataSourceProperties;
import org.candlepin.subscriptions.a_ashared.config.PostgresTlsHikariDataSourceFactoryBean;
...
@EnableJpaRepositories(
    basePackages = "org.candlepin.subscriptions.a_worker.tally.db",
...
public class InventoryDataSourceConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean inventoryEntityManagerFactory(
        ...
        return builder
                ...
                .packages("org.candlepin.subscriptions.a_worker.model")
