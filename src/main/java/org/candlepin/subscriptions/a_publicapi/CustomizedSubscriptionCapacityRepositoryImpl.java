...
/**
 * Class implementing custom queries not handled well by Spring JPA's query methods
 * DSL.
 */
@Repository
public class CustomizedSubscriptionCapacityRepositoryImpl
    ...
    @Override
    public List<SubscriptionCapacity> findByOwnerAndProductId(String ownerId, String productId,
