 ...
 */
package org.candlepin.subscriptions.a_publicapi;

import org.candlepin.subscriptions.a_worker.repository.TallySnapshotRepository;
import org.candlepin.subscriptions.a_ashared.model.Granularity;
import org.candlepin.subscriptions.a_ashared.model.ServiceLevel;
import org.candlepin.subscriptions.a_ashared.model.Usage;
import org.candlepin.subscriptions.a_ashared.config.resteasy.PageLinkCreator;
import org.candlepin.subscriptions.a_ashared.config.security.auth.ReportingAccessRequired;
import org.candlepin.subscriptions.a_worker.service.ReportFiller;
import org.candlepin.subscriptions.a_worker.service.ReportFillerFactory;
...
public class TallyResource implements TallyApi {
    ...
    public TallyReport getTallyReport(ProductId productId, @NotNull GranularityType granularityType,
        ...
        Page<org.candlepin.subscriptions.a_worker.service.snapshot.TallySnapshot> snapshotPage = repository.findByAccountNumberAndProductIdAndGranularityAndServiceLevelAndUsageAndSnapshotDateBetweenOrderBySnapshotDate(
            accountNumber,
            productId.toString(),
        ...
        List<TallySnapshot> snaps = snapshotPage.stream()
            .map(org.candlepin.subscriptions.a_worker.service.snapshot.TallySnapshot::asApiSnapshot)
