...
public final class Stoppywatch implements AutoCloseable {
  ...
  private static void outputLine(
    ...
    sb.append(
        String.format("%s|%7.6fms %s (%dns to %dns)\n", indent, elapsedMs, name, startNs, endNs));
  }

  //  public static void main(String[] args) throws InterruptedException {
  //    Logger log = LoggerFactory.getLogger("Hey");
  //    try (Stoppywatch sw = Stoppywatch.elapse(log, "Race")) {
  //      Stoppywatch.split("Lap 1");
  //      sleep(200L);
  //
  //      Stoppywatch.split("Lap 2");
  //      sleep(200L);
  //
  //      Stoppywatch.split("Lap 3");
  //      sleep(100L);
  //      try (Stoppywatch lap = Stoppywatch.elapse(log, "Pit Stop")) {
  //        Stoppywatch.split("Change Tires");
  //        sleep(100L);
  //        Stoppywatch.split("Pay with Check");
  //        sleep(100L);
  //      }
  //      sleep(100L);
  //
  //      Stoppywatch.split("Final lap");
  //      sleep(200L);
  //    }
  //    log.info("Done");
  //    try (Stoppywatch sw = Stoppywatch.elapse(log, "A Short Delay")) {
  //      sleep(250L);
  //    }
  //  }
}
